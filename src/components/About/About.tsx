    ...
    <div className="about-page">
      ...
      <div className="about-content">
        <Card
          ...
          title="What is Grease the Groove?"
          icon={Info}
        >
          <p>
      ...
      <div className="how-to-use-section">
        ...
        <div className="instructions-grid">
          <Card className="instruction-card" title="Set Your Schedule">
          ...
          <Card className="instruction-card" title="Configure Your Settings">
          ...
          <Card className="instruction-card" title="Perform Your Sets">
          ...
          <Card className="instruction-card" title="Track Your Progress">
